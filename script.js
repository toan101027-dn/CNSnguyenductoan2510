...
const projects = {
  ...
  3: {
    ...
    attach: 'Cặp Prompt đối sánh (PDF)',
    attachIcon: 'fa-file-pdf',
  },
  4: {
    ...
    attach: 'Minh chứng thư mục nhóm (PDF)',
    attachIcon: 'fa-file-pdf',
  },
  5: {
...
// Khớp chính xác 100% với danh sách file PDF hiện tại trong thư mục documents của Toàn
let uploadedFiles = {
  1: [
    {
  ...
  2: [
    {
      name: "NguyenDucToan_BaiTap2.pdf",
      size: "420 KB",
      typeClass: "pdf",
      data: "documents/NguyenDucToan_BaiTap2.pdf"
    }
  ],
  3: [
    {
      name: "NguyenDucToan_BaiTap3.pdf",
      size: "315 KB",
      typeClass: "pdf",
      data: "documents/NguyenDucToan_BaiTap3.pdf"
    }
  ],
  4: [
    {
      name: "NguyenDucToan_BaiTap4.pdf",
      size: "512 KB",
      typeClass: "pdf",
      data: "documents/NguyenDucToan_BaiTap4.pdf"
    }
  ],
  5: [
    {
      name: "NguyenDucToan_BaiTap5.pdf",
      size: "640 KB",
      typeClass: "pdf",
      data: "documents/NguyenDucToan_BaiTap5.pdf"
    }
  ],
  6: [
    {
      name: "NguyenDucToan_BaiTap6.pdf",
      size: "380 KB",
      typeClass: "pdf",
      data: "documents/NguyenDucToan_BaiTap6.pdf"
    }
  ]
};
